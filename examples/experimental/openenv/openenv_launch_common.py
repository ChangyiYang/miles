...
# Backend names/aliases resolve through openenv_sandbox_common (the canonical
# registry): "agentenv" is an accepted alias for "e2b" — AgentENV
# (https://github.com/kvcache-ai/AgentENV) is a self-hosted Firecracker
# microVM platform whose native API is the E2B API, so it runs on the e2b leg
# with E2B_API_URL/E2B_SANDBOX_URL pointed at it.
