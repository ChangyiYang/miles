...
server) or a per-episode sandbox agent function (Daytona by default when
``openenv_tb2_tasks_dir`` is set; ``--openenv-sandbox-backend e2b``/``agentenv``
for an E2B-compatible provider). tbench2 is
